...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/astral-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2725&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/astral-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `astral` can be installed with:

```
conda install astral
```

It is possible to list all of the versions of `astral` available on your platform with:
